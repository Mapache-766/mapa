...
const wordLists = [
    ['Piano', 'Guitarra', 'Flauta', 'Trompeta', 'Saxofón'],
    ['Banjo', 'Clarinete', 'Oboe', 'Viola', 'Cello'],
    ['Luna', 'Estrella', 'Cometa', 'Planeta', 'Galaxia'],
    ['Robot', 'Android', 'Cyborg', 'Holograma', 'Autómata'],
    ['Fotografía', 'Cinematografía', 'Edición', 'Dirección', 'Guionismo']    
];
